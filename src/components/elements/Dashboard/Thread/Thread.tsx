...
<div className="main-projects">
  ...
  <div className='submenu'>
    <div className='submenu__buttons '>
        <span className='submenu__button submenu__button_active '>Inbox ({inboxQTY})</span>
        <span className='submenu__button '>Sent</span>
        <span className='submenu__button '>Delete</span>
    </div>
  ...
  <div className="inbox">
    <div className="inbox__dialogues-container">
      ...
      <div className="inbox__dialogues-btn-wrapper">
        <button className="inbox__dialogues-btn" data-modal="btn">
  ...
  <div className="modal">
    <div className="modal-container">
      <h2 className="modal__title">Start tread from:</h2>
      <ul className="modal__list">
        <li className="modal__list-item">User 1</li>
        <li className="modal__list-item">User 2</li>
        <li className="modal__list-item">User 3</li>
      </ul>
    </div>
  </div>
