...
export default class ThreadContent extends React.Component {
  ...
  render() {
    return <div className="threadContent">
      ...
      <div className="thread__dialogues-btn-wrapper">
        <button className="thread__dialogues-btn">
          <span className="thread__dialogues-btn-sign">+</span>
          <span className="thread__dialogues-btn-text">New conversation</span>
        </button>
      </div>
      </div>
      ...
      <div className="chatUserInfo">
        <div className="chatUserInfo-details">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias commodi, corporis cumque id illo iusto
            molestiae numquam quibusdam rerum saepe, sequi sint tenetur veniam. At ducimus laudantium saepe sed
            temporibus.</p>
        </div>
